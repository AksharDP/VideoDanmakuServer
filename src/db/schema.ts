...
export const scrollModeEnum = pgEnum('scroll_mode_enum', ['slide', 'top', 'bottom']);
export const fontSizeEnum = pgEnum('font_size_enum', ['small', 'normal', 'large']);
...
export const users = pgTable("users", {
    ...
    unique("platform_username").on(table.platform, table.username),
]);
...
export const videos = pgTable("videos", {
    ...
    unique("platform_videoId").on(table.platform, table.videoId),
]);
